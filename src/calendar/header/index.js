...
class CalendarHeader extends Component {
  ...
  onPressMonth() {
    const { onPressMonthText } = this.props;
    if (typeof onPressMonthText === 'function') {
      return onPressMonthText();
    }
  }
    ...
    return (
      <View style={this.props.style}>
        <View style={this.style.header}>
          {leftArrow}
          <TouchableOpacity style={{ flexDirection: 'row' }} onPress={this.onPressMonth}>
